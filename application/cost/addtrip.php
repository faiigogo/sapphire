  ...
  <tr>
    ...
    <td valign="top" style="background-repeat: no-repeat; background-position:right bottom "><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<?
	include("header_cost.php"); // ËÑÇâ»Ãá¡ÃÁ
		?>
		  ...
		  ?>-->
            ...
            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#FFFFFF">
              ...
              <tr>
                ...
                if($pri =='100'){
				?>
    			<a href="alert_report.php" target="_blank"><img src="images/16x16/sms.png" width="16" height="16" border="0" alt="ÃÒÂª×èÍ¼Ùé»Ô´·ÃÔ»ªéÒ"></a>
    			<? }?>
                </td>
              ...
              <tr>  
				...
				<table width="95%" border="0" align="center" cellpadding="1" cellspacing="5">
                  ...
                  <tr>
                    ...
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?nonfin=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">à©¾ÒÐ·ÕèÂÑ§´Óà¹Ô¹¡ÒÃ</a>&nbsp;</td>
                    </tr>
                  <tr>
                    <td align="center"><img src="images/promo_violet.png" title="ÊÃØ»¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹" width="24" height="24"></td>
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?cleartrip=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">ÊÃØ»¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹</a>&nbsp;</td>
                    </tr>
                  <tr>
                    <td align="center"><img src="images/promo_green.png" title="¼èÒ¹¡ÒÃµÃÇ¨ÃÑºàÍ¡ÊÒÃÃÍ¡ÒÃÍ¹ØÁÑµÔ" width="24" height="24"></td>
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?close=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">¼èÒ¹¡ÒÃµÃÇ¨ÃÑºàÍ¡ÊÒÃ ÃÍ¡ÒÃÍ¹ØÁÑµÔ</a>&nbsp;</td>
                    </tr>
                  <tr>
                    <td align="center"><img src="images/promo_orange.png" title="ºÑ¹·Ö¡ÃÒÂ¡ÒÃ¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹" width="24" height="24"></td>
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?endtrip=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">ºÑ¹·Ö¡ÃÒÂ¡ÒÃ¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹</a>&nbsp;</td>
                    </tr>
                  <tr>
                    <td align="center"><img src="images/promo_red.png" title="ÍÂÙèã¹ÃÐËÇèÒ§¡ÒÃ»éÍ¹ÃÒÂ¡ÒÃ" width="24" height="24"></td>
                    <td style="background-color:#FFFFFF"><nobr>&nbsp;<a href="?entry=y&showall=&year_r=<?=$year_r?>&view=<?=$view?>">ÍÂÙèã¹ÃÐËÇèÒ§¡ÒÃ»éÍ¹ÃÒÂ¡ÒÃ</a>&nbsp;</td>
                    </tr>
                </table>
...
?>
            ...
            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>&nbsp;<?=$previous_url?></td>
                    <td><strong>¾.È.<?=$year_r?></strong></td>
                    <td><?=$next_url?>&nbsp;</td>
                  </tr>
                </table></td>
                <td width="68%" align="center">&nbsp;</td>

                <td width="16%" align="right"><a href="?action=add"><img src="images/add.png" width="24" height="24" border="0">à¾ÔèÁÃÒÂ¡ÒÃ Trip</a>&nbsp;&nbsp;</td>
            ...
            <table width="98%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#666666">
              ...
              <tr bgcolor="#A3B2CC">
                ...
                <td width="4%" height="25" align="center" bgcolor="#2A007C" class="style4"><b>ÅÓ´Ñº</b></td>

                <td width="4%" height="25" align="center" bgcolor="#2A007C" class="style4">&nbsp;</td>

                <td width="9%" height="25" align="center" bgcolor="#2A007C" class="style4"><strong>ÃËÑÊTrip</strong></td>

                <td width="30%" height="25" align="center" bgcolor="#2A007C" class="style4"><strong>ª×èÍTrip</strong></td>

                <?

			if($pri =='100' || $pri =='80'){
			echo "<td align=\"center\" height=\"25\" align=\"center\" bgcolor=\"#2A007C\" class=\"style4\"><strong>ª×èÍStaff</strong></td>";
			}
			?>
                <td width="33%" height="25" align="center" bgcolor="#2A007C" class="style4"><strong>ËÁÒÂàËµØ</strong></td>
			<?
			if($pri =='100' || $pri =='80'){
			echo "<td align=\"center\" height=\"25\" align=\"center\" bgcolor=\"#2A007C\" class=\"style4\"><nobr>&nbsp;·ÓÃÒÂ¡ÒÃ&nbsp;</nobr>Í¹ØÁÑµÔ</td>";
			echo "<td align=\"center\" height=\"25\" align=\"center\" bgcolor=\"#2A007C\" class=\"style4\">ÍÍ¡ÃÒÂ§Ò¹ GL</td>";
			}
			?>

                <td width="12%" height="25" align="center" bgcolor="#2A007C" class="style4"><strong>à¤Ã×èÍ§Á×Í</strong></td>
				<? if($pri == "100"){?>
                <td width="8%" align="center" bgcolor="#2A007C" class="style4"><strong>ÅéÒ§Ê¶Ò¹Ð</strong></td>
				<? } ?>
              </tr>
       ...
       <?php
		...
		if($close=="y"){
			...
			$cond = " AND trip.trip_status < '4' ";
		}else{ // ¡Ã³Õ DEFAULF ·Õè ÂÑ§äÁèàÊÃç¨ÊÔé¹ 
			$cond = " AND trip.trip_status < '4' ";		
		}

		$inner_code=$inner_code?$inner_code:""; // Inner JOIN list  ON  trip.tripid =  list.tripid   ¾ÂÒÂÒÁ ËÅÕ¡àÅÕèÂ§ ¡ÒÃãªé LEFT áÅéÇ
		...
		?>
              <tr bgcolor="<?=$bg?>">
				...
				if ($rs["trip_status"] == "1" ){
						echo "<img src=\"images/promo_red.png\" alt=\"ÍÂÙèã¹ÃÐËÇèÒ§¡ÒÃ»éÍ¹ÃÒÂ¡ÒÃ\" width=\"24\" height=\"24\">";
				}else if ($rs["trip_status"] == "4" ){
						echo "<img src=\"images/promo_violet.png\" alt=\"ÊÃØ»¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹\" width=\"24\" height=\"24\">";
				}else if ($rs["trip_status"] == "3" ){
						echo "<img src=\"images/promo_green.png\" alt=\"¼èÒ¹¡ÒÃµÃÇ¨ÃÑºàÍ¡ÊÒÃÃÍ¡ÒÃÍ¹ØÁÑµÔ\" width=\"24\" height=\"24\">";
				}else if ($rs["trip_status"] == "2" ){
						echo "<img src=\"images/promo_orange.png\" alt=\"ºÑ¹·Ö¡ÃÒÂ¡ÒÃ¤èÒãªé¨èÒÂàÊÃç¨ÊÔé¹\" width=\"24\" height=\"24\">";
				}else{
						echo "<img src=\"images/promo_red.png\" alt=\"ÍÂÙèã¹ÃÐËÇèÒ§¡ÒÃ»éÍ¹ÃÒÂ¡ÒÃ\" width=\"24\" height=\"24\">";
				}
				?>
		...
		//	$_SESSION[userid] = $rsx[userid] ;
			...
			?>
                ...
                <a href="trip_detail.php?tripid=<?=$rs[tripid]?>"><img src="images/16x16/id_card.png" width="16" height="16" border="0" title="ÃÒÂ§Ò¹¡ÒÃà´Ô¹·Ò§à¾×èÍÍÍ¡»¯ÔºÑµÔË¹éÒ·Õèã¹µèÒ§¨Ñ§ËÇÑ´" align="absmiddle"></a>&nbsp;&nbsp;
                <?php
                ...
                <img src="images/ico_register.gif" border="0" width="16" title="ÃÒÂ¡ÒÃ¤èÒãªé¨èÒÂ¢Í§ÅÙ¡·ÕÁ" align="absmiddle"/></a>	&nbsp;&nbsp;
				<?php } ?>	
                ...
                <a href="upload.php?tripid=<?=$rs[tripid]?>"><img src="images/16x16/attachment.png" alt="¨Ñ´¡ÒÃä¿Åìá¹º" width="16" height="16" border="0" align="absmiddle"></a>
				<?
				$sqlcheck = "
				...
				?>
				<a href="#" onClick="if (confirm('¤Ø³¨Ð·Ó¡ÒÃÅº¢éÍÁÙÅã¹á¶Ç¹ÕéãªèËÃ×ÍäÁè!!')) location.href='?action=delete&tripid=<?=$rs[tripid]?>';" >
				...
				if($num_unc > 0 ){?><img src="images/16x16/lock.png" width="16" height="16" border="0" alt="ÅéÒ§¤èÒÊ¶Ò¹Ð" style="cursor:pointer" onClick="if(confirm('µéÍ§¡ÒÃ»Å´ÅêÍ¡¨ÃÔ§ËÃ×ÍäÁè')==true){popWindow('clear_status.php?tripid=<?=$rs[tripid]?>&action=clear_value','450','200'); }"><? }?></td>
				<? } ?>
              </tr>
              <?
		}
...
?>
            ...
            <form  name="form1" method = POST  action = "<?  echo $PHP_SELF ; ?>" onSubmit="return ch1();">
			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center">
                ...
                <tr>
                  ...
                  <td align="right" valign="middle"><strong>ÃËÑÊTrip</strong></td>
                ...
                <tr>
                  ...
                  <td align="right" valign="middle" width="20%"><strong>ª×èÍTrip</strong></td>
                ...
                <tr>
                  ...
                  <td align="right" valign="top"><strong>ËÁÒÂàËµØ</strong></td>
                ...
                <tr>
                  <td align="right" valign="top"><strong>ªèÇ§àÇÅÒ</strong></td>
                  <td align="left" valign="top">
				    <?
					 ...
					 if(@mysql_num_rows($resultid_time)>1){
						 ...
						 $resultid_time  = mysql_db_query($db_name,$strSQL);
						 while ($rs_time = mysql_fetch_assoc($resultid_time)){	
							echo "<div><strong>¤ÃÑé§·Õè $rs_time[no_ref]</strong> µÑé§áµèÇÑ¹·Õè ".swapdatedat($rs_time[start_date])."  ¶Ö§ ".swapdatedat($rs_time[end_date])." &nbsp;&nbsp;&nbsp;&nbsp; ºÑ¹·Ö¡àÁ×èÍàÇÅÒ $rs_time[timestamp]</div>"; 
						 }
						 echo "<strong><i>¤ÃÑé§ÅèÒÊØ´</i></storng>";
					 }else{
					 ...
					 if(@mysql_num_rows($resultid_time)>0){
						echo "<div id='late_date' style='display:none'><strong>¤ÃÑé§·Õè $no_ref</strong> µÑé§áµèÇÑ¹·Õè $getdayA  ¶Ö§ $getdayB &nbsp;&nbsp;&nbsp;&nbsp; ºÑ¹·Ö¡àÁ×èÍàÇÅÒ $time_ref</div>"; 	 
					 }					 
                      ?>

                  	  <input type="text" name="getdayA" id="getdayA" readonly value="<?=$getdayA?>">
                  	  <input type='button' onClick="popUpCalendar(this, form1.getdayA, 'dd/mm/yyyy')" value=' àÅ×Í¡ÇÑ¹ ' class='input' onFocus="header_trip();" <?=$disabled?>>
                   		¶Ö§
                      <input type="text" name="getdayB" id="getdayB" readonly value="<?=$getdayB?>" onFocus="header_trip();">
               	    <input type='button' onClick="popUpCalendar(this, form1.getdayB, 'dd/mm/yyyy')" value=' àÅ×Í¡ÇÑ¹ ' class='input' <?=$disabled?>>
					  <? if ($_GET[action]=="edit2"){ ?>
                      <br />
                  	  <INPUT NAME="schedule_id" TYPE="hidden" id="schedule_id" VALUE="<?=$schedule_id?>">
                      <INPUT NAME="no_ref" TYPE="hidden" id="no_ref" VALUE="<?=$no_ref?>">
                      <input name="trip_advance" id="trip_advance" type="checkbox" value="ON" <?=$add_news=="true"?"checked":""?> onClick="show_time('late_date')" <?=$disabled?>/> ÃÐºØà»ç¹ªèÇ§àÇÅÒµèÍà¹×èÍ§ËÃ×Íà¾ÔèÁàµÔÁ
                      <? } ?>
                      </td>
                </tr>
                <tr>
                	<td align="right"  valign="top"><strong>Ê¶Ò¹Ð</strong></td>
                	<td align="left"><input type="checkbox" name="downline_status" id="downline_status" value="1" onClick="checkDownline();" <?php echo ($rs['downline_status']==1)?"checked":"";?> <?=$disabled?>>&nbsp;à»ç¹ÅÙ¡·ÕÁ</td>
                 </tr>
                 <?php
                 ...
                 ?>
                 <tr>
                	<td align="right"  valign="top"><strong>ËÑÇË¹éÒ·ÕÁ</strong></td>
                	<td align="left">¤Ø³<?=$rs_hu['name']."  ".$rs_hu['surname'];?></td>
                 </tr>
               <?php
				 }
               ...
               ?>
                ...
                <tr>
                	<td align="right"  valign="top"><strong>ËÑÇË¹éÒàÅ×Í¡ÅÙ¡·ÕÁ</strong></td>
                	<td align="left">
                    <table>
                    	<tr>
                        <td>
                        ...
                        <option value="">àÅ×Í¡ÅÙ¡·ÕÁ</option>
                        <?php
						$begin_date = $getdayA; 
						$end_date = $getdayB;
						...
						$query_userm  = mysql_db_query($db_name,$sql_userm);
					 	while ($row_userm = mysql_fetch_assoc($query_userm)){	
							echo '<option value="'.$row_userm['userid'].'" >¤Ø³'.$row_userm['name']."  ".$row_userm['surname'].'</option>';
					 	}
                        ?>
                        </select>
                        </span>
                        ...
                        <span id="downline_trip">
                        	<select name="sl_downline_trip" id="sl_downline_trip" <?=($rs['header_trip']>0 || $rs['downline_status']==1)?"disabled":"";?>>
							  <option value="">àÅ×Í¡·Ô»</option>
                            </select>
                         </span>   
                         </td>
                         <td><input type="button" name="b_add"  id="b_add" value=" à¾ÔèÁÅÙ¡·ÕÁ " onClick="addList();" <?=($rs['header_trip']>0 || $rs['downline_status']==1)?"disabled":"";?>/></td>
                        </tr>
                    </table>
                    <ol id="files-root">
                        ...
                        <?php
						 ...
						 while($downline = mysql_fetch_assoc($q_downline)){
							 ...
							 echo "¤Ø³".$downline['name']."  ".$downline['surname'];
                ...
                <tr>
                  ...
                  <td align="left" valign="top" width="60%"><input type="submit" name="Submit" value=" ºÑ¹·Ö¡ "  <?=$disabled?>>
                      <input type="reset" name="Submit2" value="Reset" <?=$disabled?>>
                      <input type="reset" name="Submit3" value="Â¡àÅÔ¡" ONCLICK="<? if ($_GET[action] == "edit2") echo "location.href='?';"; else echo "window.close();"; ?>">
            ...
            <tr><td>
            <strong>ËÁÒÂàËµØ</strong>
            <br/>
            ÅÙ¡·ÕÁ¤×Í ºØ¤¤Å·ÕèäÁèÊÒÁÒÃ¶àºÔ¡¤èÒãªè¨èÒÂä´é´éÇÂµÑÇàÍ§  â´ÂËÑÇË¹éÒ·ÕÁ¨Ð·Ó¡ÒÃàÅ×Í¡ÅÙ¡·ÕÁ·ÕèÍÂÙèã¹¤ÇÒÁ´ÙáÅ¢Í§µÑÇàÍ§
            <p/>&nbsp;
            </td></tr>
            </table>
          </form>          
