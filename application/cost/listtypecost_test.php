...
<?= GetTripOwner($rss[tripid]) ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="25%" align="right" bgcolor="#FFFFFF"><span class="style2">
                                                                        <?
                                                                        If ($pri == "100") {
                                                                            $sqls = "select sum(cash_total) as cash_total,sum(credit_total) as credit_total  from list  where tripid = '$tripid'  and (id_type_cost = '$id_type_cost') ";
                                                                        } else {
                                                                            $sqls = "select sum(cash_total) as cash_total,sum(credit_total) as credit_total  from list  where tripid = '$tripid'  and userid= '$_SESSION[userid]' and (id_type_cost = '$id_type_cost') ";
                                                                        }
                                                                        $res = mysql_query($sqls);
                                                        ...
                                                        <table width="98%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="black">
                                                            <tr bgcolor="#A3B2CC" align="center">
                                                                ...
                                                                <td rowspan="2" bgcolor="#A3B2CC"><strong>Cost ID</strong></td>
                              									<td rowspan="2" bgcolor="#A3B2CC"><strong>Task ID</strong></td>
...
while ($rs = mysql_fetch_array($result, MYSQL_ASSOC)) {
    ...
    ?>
                               ...
                               <td align="center"><?php echo $rs['task_id'];?></td>
