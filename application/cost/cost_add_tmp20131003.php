...
?>
            ...
            function cash_value_check(x) {
                ...
                if (isNaN(txt_cash_vat) === true || txt_cash_vat < 0)
                    txt_cash_vat = 0;
				var_cash_total = txt_cash + txt_cash_vat;	
                $('input#cash_total').val(var_cash_total.toFixed(2));
            }
            ...
            function credit_value_check(x) {
				...
				var_credit_total = txt_credit + txt_credit_vat;
				
                $('input#credit_total').val(var_credit_total.toFixed(2));
            }
                                                                </script>	
                                                            ...
                                                            <td colspan="2" ><span class="style2">
                                                                    ...
                                                                    if ($action == "edit2") {
                                                                        ...
                                                                        if (!($s1 === false)) {
                                                                            ...
                                                                            $conW = "WHERE type_project.code_project NOT LIKE 'OF%' AND type_project.code_project NOT LIKE 'MAR%' AND type_project.code_project NOT LIKE 'RD%' AND type_project.code_project NOT LIKE 'PS%'  AND $db_name.type_project.code_project NOT LIKE 'MA%' ";
                                                                        }
                                                                    }
                                                                    ?>
                    ...
                    $.ajax({
                        ...
                        success: function(datatext) {
                            ...
                            for (var i = 0; i < dataArray.length; i++) {
                                // dataArray[i] = taskId,costId,taskName
                                var valueArray = dataArray[i].split(',');
                                if (<?php echo $rs[task_id]; ?> == valueArray[0]) {
