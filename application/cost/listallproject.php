...
?>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="left" valign="top"><? If ($mode !='2')
						  {
						  ?>
                          ...
                          <table width="90%" border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#A3B2CC">
                            ...
                            <tr>
                              <td width="30%" align="right"><strong>จำนวนโครงการทั้งหมด</strong></td>
                              <td width="25%" align="right" bgcolor="#FFFFFF">
							    <strong>
							    <?
							  $sq1 = " select  *  from  list group by id_type_project ";
							  $result1 = mysql_query($sq1);
							  $rs1 = mysql_num_rows($result1);
							  echo $rs1;
							  ?>
							    </strong> </td>
                              <td bgcolor="#A3B2CC"><strong>โครงการ</strong></td>
                            ...
                            <tr>
                              ...
                              <td width="25%" align="right" bgcolor="#FFFFFF"><span class="style2">
                                <?
				$sqls = "select sum(cash_total) as cash_total,sum(credit_total) as credit_total  from list ";
				...
				?>
                          ...
                          <table width="90%" border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#000000">
                            ...
                            <tr bgcolor="<?=$bg?>">
                              <td align="left" bgcolor="#A3B2CC">ชื่อโครงการ</td>
                              <td align="left" bgcolor="#A3B2CC">&nbsp;</td>
                              <td align="right" bgcolor="#A3B2CC" >จำนวนเงิน</td>
   ...
   <?
	...
	If  ($pri == '100' || $pri == '50')
	{
		If ($sortfield == "")
		{
			$str = " select  sum(t1.cash_total+t1.credit_total) as total,t2.code_project,t1.id_type_project  from list t1 left join type_project t2 on t1.id_type_project = t2.id_type_project   group by  t1.id_type_project   order by date_list   ; ";
		}
		else
		{ 
			$str = " select  sum(t1.cash_total+t1.credit_total) as total,t2.code_project,t1.id_type_project from list t1 left join type_project t2 on t1.id_type_project = t2.id_type_project    group by  t1.id_type_project    order by $sortfield  $sort ; ";
		}
	}else
	{
			If ($sortfield == "")
...
?>
                            <tr bgcolor="<?=$bg?>">
                              ...
                              <td width="16%" bgcolor="<?=$bg?>"><a href="?id_type_project=<?=$rs[id_type_project]?>&mode=2">(แสดงรายละเอียด)</a></td>
                            </tr>
<?
}
?>
         <tr bgcolor="<?=$bg?>">
						  ...
						  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2C2C9E">
                            ...
                            <tr bgcolor="#CACACA">
                              <td width="862" bgcolor="#888888">&nbsp;</td>
                              <td width="108" align="right" bgcolor="#888888"><a href="general.php"></a><font style="font-size:16px; font-weight:bold; color:#FFFFFF;">
                                <input name="Button25" type="button" class="xbutton" id="Button25"  style="width: 80;"  title="ยกเลิก" onClick="location.href='listallproject.php';" value="กลับหน้ารายการ" >
                                &nbsp;</font>&nbsp;&nbsp;          &nbsp;&nbsp; </td>
                            </tr>
                          </table>
						  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
						  ...
						  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="2" bgcolor="#A3B2CC">
                            <tr>
                              <td width="30%" align="right"><span class="style2">รหัสโครงการ</span></td>
                              <td width="50%" align="center" bgcolor="#FFFFFF"><span class="style2">
                                <?
				$sqls = "select * from type_project where id_type_project = '$id_type_project' ";
				$res = mysql_query($sqls);
				...
				?>
                            ...
                            <tr>
                              <td width="30%" align="right"><strong>ชื่อโครงการ: </strong></td>
                            ...
                            <tr>
							  ...
							  $sqld = "select max(date_list) as maxdate,min(date_list) as mindate from list where id_type_project = '$id_type_project' ";
                            ...
                            <tr>
                              ...
                              <td width="50%" align="right" bgcolor="#FFFFFF"><span class="style2">
                                <?
			
				$sqls = "select sum(cash_total) as cash_total,sum(credit_total) as credit_total  from list  where  (id_type_project = '$id_type_project') ";
				...
				?>
                            ...
                            <tr>
                              ...
                              <td width="50%" align="right" bgcolor="#FFFFFF"><strong>
                                <?=number_format($resc[credit_total],2);?>
                              </strong></td>
                              <td bgcolor="#A3B2CC"><strong>บาท&nbsp;</strong></td>
                            </tr>
                          ...
                          <table width="98%" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="black">
                            <tr bgcolor="#A3B2CC" align="center">
                              ...
                              <td rowspan="2" bgcolor="#A3B2CC"><strong><a href="?<?=$getstr?>sortfield=date_list&tripid=<?=$tripid?>&id_type_project=<?=$id_type_project?>&mode=2">วันที่</a></strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong>RefID</strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong>รายการ</strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong><a href="?<?=$getstr?>sortfield=userid&tripid=<?=$tripid?>&id_type_project=<?=$id_type_project?>&mode=2">Staff</a></strong></td>
                              <td colspan="3" bgcolor="#A3B2CC"><strong>จำนวนเงิน</strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong><a href="?<?=$getstr?>sortfield=id_type_cost&tripid=<?=$tripid?>&id_type_project=<?=$id_type_project?>&mode=2">หมวดค่าใช้จ่าย</a></strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong>Cost ID</strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong>TOR ID</strong></td>
                              <td rowspan="2" bgcolor="#A3B2CC"><strong><a href="?<?=$getstr?>sortfield=complete&tripid=<?=$tripid?>&id_type_project=<?=$id_type_project?>&mode=2">BILL</a></strong></td>
                              <td bgcolor="#A3B2CC">&nbsp;</td>
                            </tr>
                            <tr bgcolor="#A3B2CC" align="center">
	...
	If ($sortfield == "")
		{
			$str = "select *  from list t1 left join type_project t2 on t1.id_type_project = t2.id_type_project where  (t1. id_type_project='$id_type_project')  order by date_list  ";
		}else
		{
		$str = " select *  from list t1 left join type_project t2 on t1.id_type_project = t2.id_type_project where  (t1. id_type_project='$id_type_project')  order by t1.$sortfield $sort  ";
		}
	$result = mysql_query($str);
	while ($rs=mysql_fetch_array($result,MYSQL_ASSOC)){
