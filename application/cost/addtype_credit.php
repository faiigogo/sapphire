        ...
        <td height="60" bgcolor="#2C2C9E"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="85%"><B class="pheader">
                <?=($rs[runid]!=0?"แก้ไข":"เพิ่ม")?>ประเภทบัตรเครดิต</B></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td valign="top" ><p>&nbsp;</p>
            <table width="80%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="black">
              <tr bgcolor="#A3B2CC">
                ...
                <td width="40%"><div align="center"><strong>ประเภทบัตรเครดิต</strong></div></td>
		...
		?>
              <tr bgcolor="<?=$bg?>">
                ...
                <td  align="center"><input class="xbutton" style="width: 70;" type="button" value="Edit" onClick="location.href='?id_type_credit=<?=$rs[id_type_credit]?>&action=edit2';" name="button2">
                    <input class="xbutton"  style="width: 70;" type="button" value="Delete" onClick="if (confirm('คุณจะทำการลบข้อมูลในแถวนี้ใช่หรือไม่!!')) location.href='?action=delete&id_type_credit=<?=$rs[id_type_credit]?>';" name="button">
                </td>
              </tr>
              <?
		}
              ...
              <table width="80%" border="0" cellspacing="1" cellpadding="2" align="center">
                <tr>
                  <td colspan=3 align="left" valign="top" bgcolor="#888888"><B class="gcaption">
                    <?=($rs[id_type_credit]!=0?"แก้ไข":"เพิ่ม")?>
                    ประเภทบัตรเครดิต</B></td>
                </tr>
                <tr>
                  <td align="right" valign="middle" width="20%">ประเภทบัตรเครดิต</td>
